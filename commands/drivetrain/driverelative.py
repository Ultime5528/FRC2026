...
class DriveRelative(Command):
    ...
    def right(cls, drivetrain: Drivetrain):
        cmd = cls(
            drivetrain, lambda: Translation2d(0, -1) * drive_relative_properties.speed
        )
    ...
    def forwards(cls, drivetrain: Drivetrain):
        cmd = cls(
            drivetrain, lambda: Translation2d(1, 0) * drive_relative_properties.speed
        )
    ...
    def __init__(
        ...
        speed: Union[Translation2d, Callable[[], Translation2d]],
    ):
        super().__init__()
